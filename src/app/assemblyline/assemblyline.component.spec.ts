...
describe("AssemblyLineComponent", () => {
  ...
  describe("renders correct elements", () => {
    ...
    it("should have an element with the data-testid attribute 'assembly-add-item'", () => {
      const addElem = fixture.debugElement.query(
        By.css('*[data-testid="assembly-add-item"]')
      );
      expect(addElem).not.toBeNull();
    ...
    it("should have 4 elements with the 'assembly-stage' data-testid attribute", () => {
    ...
    it("should have 0 elements with the 'assembly-item' data-testid attribute initially", () => {
      const itemsElem = fixture.debugElement.query(
        By.css('*[data-testid="assembly-item"]')
      );
    ...
    describe('when "goldenrod" is typed into data-testid "assembly-add-item"', () => {
      ...
      describe('when enter key is pressed on "assembly-add-item"', () => {
        ...
        it('should have a single item in the first stage after Enter on "assembly-add-item"', () => {
          ...
          const children = stageElem.nativeElement.querySelectorAll('*[data-testid="assembly-item"]');
    ...
    describe("with 4 items initially added to Idea stage", () => {
      ...
      const getStage = (stageIndex: number) => {
        ...
        return stage.nativeElement
          .querySelectorAll('*[data-testid="assembly-item"]');
      };
